...
import { loginUser } from '../services/authService'   // ✅ updated import
...
const SignInPage = (): JSX.Element => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      // ✅ unified login — backend identifies buyer or seller
      ...
      // ✅ set role-specific profile in redux
      if (role === 'seller') {
      ...
      // ✅ use redirectTo from backend — navigates to their specific page
