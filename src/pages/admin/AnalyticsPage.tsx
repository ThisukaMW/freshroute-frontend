...
//       value: "320",
//       sub: "+8% vs yesterday",
//       color: "from-emerald-400/70 via-emerald-500/60 to-accent-blue/60",
//     },
//     {
//       label: "On-time delivery rate",
//       value: "96%",
//       sub: "Target 95%",
//       color: "from-supply-peach/70 via-supply-orange/60 to-supply-teal/60",
//     },
//     {
//       label: "Repeat customers",
//       value: "42%",
//       sub: "Last 30 days",
//       color: "from-supply-teal/70 via-supply-deep/60 to-supply-peach/60",
//     },
//     {
//       label: "GMV (this month)",
//       value: "Rs. 12.5M",
//       sub: "Platform gross merchandise value",
//       color: "from-emerald-500/70 via-accent-blue/60 to-slate-900/60",
//     },
//   ];
...
//         High-level demo of the kinds of charts and KPIs you could build: volumes, reliability and
//         customer behaviour.
//       </p>
...
//           <div
//             key={c.label}
//             className="rounded-2xl border border-white/10 bg-supply-deep/80 p-4 shadow-[0_25px_80px_rgba(0,0,0,0.9)] backdrop-blur-xl"
//           >
//             <p className="text-[11px] font-medium uppercase tracking-[0.18em] text-slate-400">
//               {c.label}
//             </p>
//             <p className={`mt-3 inline-flex items-baseline rounded-xl bg-gradient-to-r ${c.color} px-3 py-2 text-lg font-semibold text-slate-50`}>
//               {c.value}
//             </p>
//             <p className="mt-2 text-[11px] text-slate-300">{c.sub}</p>
//           </div>
//         ))}
//       </div>

//       <div className="grid gap-4 md:grid-cols-2">
//         <div className="rounded-2xl border border-white/10 bg-supply-deep/80 p-4 text-xs text-slate-100 backdrop-blur-xl">
//           <p className="text-sm font-semibold text-slate-50">Orders by time of day (demo)</p>
//           <p className="mt-2 text-[11px] text-slate-400">
//             Use this area to show a chart of order volume across hours, explaining peak delivery
//             windows.
//           </p>
//           <div className="mt-4 h-32 rounded-xl bg-gradient-to-r from-supply-teal/40 via-supply-peach/40 to-supply-orange/40" />
//         </div>
//         <div className="rounded-2xl border border-white/10 bg-supply-deep/80 p-4 text-xs text-slate-100 backdrop-blur-xl">
//           <p className="text-sm font-semibold text-slate-50">City performance (demo)</p>
//           <p className="mt-2 text-[11px] text-slate-400">
//             Another slot where you could add a bar chart comparing GMV, orders and on-time rate by
//             city.
//           </p>
//           <div className="mt-4 h-32 rounded-xl bg-gradient-to-r from-supply-peach/40 via-supply-teal/40 to-slate-800/60" />
//         </div>
//       </div>
//     </div>
//   );
