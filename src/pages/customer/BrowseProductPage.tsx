    ...
    <div className="min-h-screen bg-slate-900 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-400 mt-2">Browse and add products to your cart</p>
        </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="w-64 flex-shrink-0">
            <div className="bg-slate-800 rounded-xl p-6 space-y-6">
              {/* Categories */}
              <div>
                <h3 className="text-sm font-semibold text-slate-50 mb-3">Categories</h3>
              ...
              {/* Price Range */}
              <div>
                <h3 className="text-sm font-semibold text-slate-50 mb-3">Price Range</h3>
                <div className="space-y-3">
                  <div>
                    <label className="text-xs text-slate-400">Min: ${priceRange.min}</label>
                    <input
                      type="range"
                      min="0"
                      max="500"
                  ...
                  <div>
                    <label className="text-xs text-slate-400">Max: ${priceRange.max}</label>
                    <input
                      type="range"
                      min="0"
                      max="500"
              ...
              {/* Search */}
              <div>
                <h3 className="text-sm font-semibold text-slate-50 mb-3">Search</h3>
                <input
                  type="text"
                ...
                {filteredProducts.map((product) => (
                  ...
                  >
                    ...
                    <div className="p-4 space-y-3">
                      <h3 className="font-semibold text-slate-50">{product.name}</h3>
                      <p className="text-xs text-slate-400">{product.category}</p>

                      <div className="flex justify-between items-end">
                        <div>
                          <p className="text-2xl font-bold text-primary">${product.pricePerUnit}</p>
...
function getProductsBySeller(sellerId: string) {
