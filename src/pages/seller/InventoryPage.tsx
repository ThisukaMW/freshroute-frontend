  ...
  if (loading) {
    return (
      <div className="space-y-8 text-slate-100">
        <div className="animate-pulse rounded-3xl border border-white/10 bg-slate-950/40 px-5 py-6">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-supply-peach">
            Loading...
          </p>
        </div>
      </div>
    ...
    <div className="space-y-8 text-slate-100">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          highlight={
            lowStockItems.length > 0 ? "amber" : undefined
          }
        />
        ...
        <StatCard
          ...
          highlight={
            outOfStockItems.length > 0 ? "red" : undefined
          }
        />
      </section>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            {restockSuggestions.map((entry) => (
              ...
              >
                ...
                <p className="text-xs text-slate-400">
                  Current: {entry.currentStock} · Recommended: +
